...
public class JSONArray extends JSONEntity {
     ...
     * Если тип передаваемого элемента не поддерживается, добавляет вместо него {@link JSONString}
     * c содержимым, соответствующим строковому представлению переданного элемента.
     * Iспользуется в случае, когда нужно создать массив из разных типов элементов
     * @param items элементы создаваемого массива
     */
